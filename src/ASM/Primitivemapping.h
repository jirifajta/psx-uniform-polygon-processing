...
#ifndef Primitivemapping_H_INCLUDED
#define Primitivemapping_H_INCLUDED
 ...
 * NOT supported primitive data structs:
 *  LINE_F3, LINE_F4, LINE_G3, LINE_G4 and all types of DR_X (like DR_MODE, DR_TWIN and so on).
 *
 * Requirements:
